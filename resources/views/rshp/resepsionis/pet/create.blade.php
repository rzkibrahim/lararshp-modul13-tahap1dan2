...
@section('page_title', 'Tambah Data Pet')
@section('page_description', 'Registrasi hewan peliharaan baru')
    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden card-hover">
        ...
        <div class="bg-gradient-to-r from-primary-600 to-primary-700 px-6 py-4">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <h2 class="text-xl font-semibold text-white">Registrasi Pet Baru</h2>
                    <p class="text-primary-100 text-sm mt-1">Lengkapi formulir data hewan peliharaan</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-gradient-to-r from-amber-50 to-orange-50 border-l-4 border-amber-500 p-4 m-6">
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    <p class="text-sm text-amber-800 font-medium">Pastikan data lengkap dan akurat untuk memudahkan pelayanan medis hewan</p>
                </div>
            </div>
        </div>

        {{-- Form --}}
        <form action="{{ route('resepsionis.pet.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition duration-200"
                           placeholder="Contoh: Putih dengan bintik hitam di telinga kanan">
                </div>
                ...
                <div>
                    ...
                    <select id="idras_hewan" 
                            name="idras_hewan"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition duration-200 @error('idras_hewan') border-red-500 @enderror"
                            required>
                ...
                <div>
                    ...
                    <select id="idpemilik" 
                            name="idpemilik"
                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition duration-200 @error('idpemilik') border-red-500 @enderror"
                            required>
