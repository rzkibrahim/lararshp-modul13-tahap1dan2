...
<head>
    ...
    <title>@yield('title', 'Dashboard Perawat - RSHP')</title>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="text-right hidden md:block">
                            <p class="font-semibold text-white">{{ session('user_name', 'Perawat') }}</p>
                            <p class="text-primary-200 text-sm">Perawat</p>
                        </div>
        ...
        <div class="flex flex-1">
            ...
            <aside class="w-64 bg-white shadow-xl border-r border-gray-200 sidebar-transition">
                <div class="p-6">
                    {{-- Navigation --}}
                    <nav class="space-y-2">
                        <h3 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Menu Perawat</h3>
                        ...
                        <a href="{{ route('perawat.dashboard') }}"
                           ...
                           {{ request()->routeIs('perawat.dashboard') 
                        ...
                        <a href="{{ route('perawat.rekam-medis.index') }}"
                           class="nav-item flex items-center space-x-3 px-3 py-3 rounded-xl transition-all duration-200 
                           {{ request()->routeIs('perawat.rekam-medis.*') 
                                ? 'bg-primary-50 text-primary-700 font-semibold active border border-primary-100' 
                                : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <div class="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center">
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="space-y-3">
                            <div class="flex items-center justify-between p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-lg border border-orange-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 rounded-lg bg-orange-100 flex items-center justify-center">
                                        <i class="fas fa-user-injured text-orange-600 text-sm"></i>
                                    </div>
                                    <span class="text-sm font-medium text-gray-700">Pasien</span>
                                </div>
                                <span class="text-lg font-bold text-orange-600">{{ $pasienDirawat ?? 0 }}</span>
                            </div>
                            
                            <div class="flex items-center justify-between p-3 bg-gradient-to-r from-yellow-50 to-amber-50 rounded-lg border border-yellow-100">
                                <div class="flex items-center space-x-3">
                                    <div class="w-8 h-8 rounded-lg bg-yellow-100 flex items-center justify-center">
                                        <i class="fas fa-syringe text-yellow-600 text-sm"></i>
                                    </div>
                                    <span class="text-sm font-medium text-gray-700">Tindakan</span>
                                </div>
                                <span class="text-lg font-bold text-yellow-600">{{ $totalTindakan ?? 0 }}</span>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-3 bg-gradient-to-r from-red-50 to-orange-50 rounded-lg border border-red-100">
                                ...
                                <span class="text-lg font-bold text-red-600">{{ $pasienMenunggu ?? 0 }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-gray-600 mt-2 text-lg">@yield('page_description', 'Selamat datang di dashboard perawat')</p>
                            </div>
