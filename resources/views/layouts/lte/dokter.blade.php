                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="text-right hidden md:block">
                            <p class="font-semibold text-white">{{ session('user_name', 'Dokter') }}</p>
                            <p class="text-primary-200 text-sm">Dokter</p>
                        </div>
                ...
                <div class="p-6">
                    ...
                    <nav class="space-y-2">
                        ...
                        <a href="{{ route('dokter.rekam-medis.list') }}"
                           class="nav-item flex items-center space-x-3 px-3 py-3 rounded-xl transition-all duration-200 
                           {{ request()->routeIs('dokter.rekam-medis.*') 
                                ? 'bg-primary-50 text-primary-700 font-semibold active border border-primary-100' 
                                : 'text-gray-600 hover:bg-gray-50 hover:text-gray-900' }}">
                            <div class="w-8 h-8 rounded-lg bg-primary-100 flex items-center justify-center">
                    ...
                    <div class="mb-8">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-gray-600 mt-2 text-lg">@yield('page_description', 'Selamat datang di dashboard dokter')</p>
                            </div>
